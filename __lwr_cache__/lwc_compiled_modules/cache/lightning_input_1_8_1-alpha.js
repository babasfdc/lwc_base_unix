...
import { assert, classListMutation, ContentMutation, getRealDOMId, isIE11, isNotUndefinedOrNull, isUndefinedOrNull, normalizeAriaAttribute, normalizeBoolean, normalizeKeyValue, normalizeString, synchronizeAttrs, decorateInputForDragon, setDecoratedDragonInputValueWithoutEvent } from 'lightning/utilsPrivate';
...
import { calculateFractionDigitsFromStep, formatNumber, fromIsoDecimal, hasValidNumberShortcut, increaseNumberByStep, isValidNumber, isValidNumberCharacter, normalizeNumber, toIsoDecimal } from './numberUtil';
...
_registerDecorators(LightningInput, {
  ...
  fields: ["_formatter", "_showRawNumber", "_initialValueSet", "_files", "_rendered", "isConnected", "_selectionStart", "_selectionEnd"]
})
