...
function createResizeSensor(dtObserver, columnWidthManager, template, state, widthsData, resizeTarget) {
...
export class LightningDatatableResizeObserver {
  constructor(template, state, widthsData, columnWidthManager) {
    ...
    if (this._resizeObserverAvailable) {
      ...
      this._resizeSensor = createResizeSensor(this, columnWidthManager, template, state, widthsData, resizeTarget);
    }
